...
@section('content')
    ...
    <section class="max-w-screen-lg mx-auto py-16">
        <h2 class="heading--underline mb-8">{{ $title }}</h2>
        <p class="mb-8">
            {{ config('app.name') }}
            （以下，「当サイト」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第1条（個人情報）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第3条（個人情報を収集・利用する目的）</h2>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第4条（利用目的の変更）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第5条（個人情報の第三者提供）</h2>
            <p>
                当サイトは，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。</p>
            <ul>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第6条（個人情報の開示）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第7条（個人情報の訂正および削除）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第8条（個人情報の利用停止等）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第9条（プライバシーポリシーの変更）</h2>
            <p>
        ...
        <section class="mb-8">
            <h2 class="font-bold text-2xl mb-4">第10条（お問い合わせ窓口）</h2>
            <p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
            <p>
                サイト名：{{ config('app.name') }} <br/>
{{--                住所： <br/>--}}
{{--                社名： <br/>--}}
{{--                担当部署： <br/>--}}
                Eメールアドレス：{{ config('about_us.admin_email') }}
            </p>
        </section>
    </section>
@endsection

    ...
    <section id="about_us" class="pt-16 mb-20">
        <div class="w-full max-w-screen-md mx-auto">
            ...
            <form action="{{ $endpoint }}" method="{{ $method }}" class="h-adr">
                ...
                <input type="hidden" name="form_type_id" value="{{ App\Enums\FormType::DONATION_FORM }}">
                <div class="mx-auto mb-16 container--sm">
                    <dl class="form__dl">
                        ...
                        <dd class="form__dd">
                            <select class="form-input form-input__text pr-8" name="contents" id="contents">
                                @foreach($form_contents as $form_content)
                                    <option value="{{ $form_content }}">
                                        {{ $form_content }}
                                    </option>
                                @endforeach
                            </select>
